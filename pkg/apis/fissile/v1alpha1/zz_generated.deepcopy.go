...
func (in *BOSHDeploymentSpec) DeepCopyInto(out *BOSHDeploymentSpec) {
	*out = *in
	if in.OpsRefs != nil {
		in, out := &in.OpsRefs, &out.OpsRefs
		*out = make([]OpsRef, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpsRef) DeepCopyInto(out *OpsRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpsRef.
func (in *OpsRef) DeepCopy() *OpsRef {
	if in == nil {
		return nil
	}
	out := new(OpsRef)
